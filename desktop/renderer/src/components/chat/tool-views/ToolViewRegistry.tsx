...
export function getToolView(toolName: string): ToolViewComponent {
  ...
  if (lower.includes("str-replace") || lower.includes("str_replace")) return StrReplaceToolView;
  if (
  ...
  if (
    ...
    lower.includes("see_image")
  )
    return BrowserToolView;
  if (lower.includes("crawl") || lower.includes("scrape")) return WebCrawlToolView;
  if (lower.includes("search")) return WebSearchToolView;
  if (lower.includes("artifact")) return ArtifactToolView;
