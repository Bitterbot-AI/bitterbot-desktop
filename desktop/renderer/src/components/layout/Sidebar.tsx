...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: "management", label: "Management", icon: Shield, group: "control", requireFeature: "management" },
  // Agent
...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className={cn("border-b border-[var(--sidebar-border-subtle)]", isCollapsed ? "p-2" : "p-4")}>
        <button
          onClick={() => {
          ...
          <div className="flex items-center justify-between mb-1">
            ...
            {selectedSessions.size > 0 ? (
              <div className="flex items-center gap-1">
                <span className="text-[10px] text-muted-foreground">{selectedSessions.size} selected</span>
                <button
                  onClick={async () => {
                    for (const key of selectedSessions) {
                      try { await request("sessions.delete", { key }); } catch {}
                    }
      ...
      <div className={cn(
        ...
        {isCollapsed ? (
          <div className="flex flex-col items-center gap-2">
            <SocialLink href="https://about.bitterbot.ai" icon={<AboutIcon />} label="About BitterBot" collapsed />
            <SocialLink href="https://x.com/Bitterbot_AI" icon={<XIcon />} label="Follow us on X" collapsed />
            <SocialLink href="https://www.linkedin.com/company/106800101" icon={<LinkedInIcon />} label="Connect on LinkedIn" collapsed />
            <SocialLink href="mailto:team@bitterbot.net" icon={<EmailIcon />} label="Email us" collapsed isEmail />
          </div>
        ) : (
          <div className="flex flex-col gap-1">
            <SocialLink href="https://about.bitterbot.ai" icon={<AboutIcon />} label="About BitterBot" collapsed={false} />
            <SocialLink href="https://x.com/Bitterbot_AI" icon={<XIcon />} label="Follow us on X" collapsed={false} />
            <SocialLink href="https://www.linkedin.com/company/106800101" icon={<LinkedInIcon />} label="Connect on LinkedIn" collapsed={false} />
            <SocialLink href="mailto:team@bitterbot.net" icon={<EmailIcon />} label="Email us" collapsed={false} isEmail />
          </div>
        )}
      </div>
