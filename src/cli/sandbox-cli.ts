...
const SANDBOX_EXAMPLES = {
  main: [
    ["bitterbot sandbox list", "List all sandbox containers."],
    ...
    ["bitterbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["bitterbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["bitterbot sandbox list", "List all sandbox containers."],
    ["bitterbot sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["bitterbot sandbox explain", "Show effective sandbox config."],
    ["bitterbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["bitterbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["bitterbot sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.bitterbot.ai/cli/sandbox")}\n`,
    )
    .action(() => {
