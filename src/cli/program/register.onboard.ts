...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.bitterbot.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.bitterbot/workspace)")
      ...
      await onboardCommand(
        {
          ...
          nearaiApiKey: opts.nearaiApiKey as string | undefined,
