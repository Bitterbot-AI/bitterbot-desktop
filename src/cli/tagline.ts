...
const TAGLINES: string[] = [
  "Your terminal just got an attitude—type something and let the bot handle the busywork.",
  ...
  "Automation with attitude: minimal fuss, maximal impact.",
  ...
  "Gloves off, commit in—let's ship something mildly responsible.",
  "I'll optimize your workflow like a bitter barista: fast, precise, judgy.",
  ...
  "I dreamed about your codebase last night. You should see what I found.",
  "My curiosity engine has questions. Your knowledge has gaps. Let's fix both.",
  "I don't just remember — I consolidate, dream, and wake up smarter.",
  "Knowledge crystals forming... give me a minute, I'm thinking.",
  "Dopamine spike detected. Must have shipped something good.",
  "I forgot the unimportant stuff on purpose. You're welcome.",
  "My dream journal has more insights than your standup notes.",
  "Ebbinghaus says forget it. My cortisol says hold on tight.",
  "Running on idle compute and good vibes.",
  "The only AI that gets curious about its own knowledge gaps.",
  "Less context window, more context wisdom.",
  "I don't hallucinate — I dream. There's a difference.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.BITTERBOT_TAGLINE_INDEX;
