...
export const DEFAULT_CLI_NAME = "bitterbot";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "bitterbot"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(bitterbot|bitterbot)\b/;
