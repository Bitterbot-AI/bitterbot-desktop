...
export type ChannelAgentToolFactory = (params: { cfg?: BitterbotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: BitterbotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: BitterbotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: BitterbotConfig }) => boolean;
  supportsCards?: (params: { cfg: BitterbotConfig }) => boolean;
