...
import type { BitterbotPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverBitterbotPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, BitterbotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["BITTERBOT_PLUGIN_CATALOG_PATHS", "BITTERBOT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<BitterbotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: BitterbotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: BitterbotPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverBitterbotPlugins({ workspaceDir: options.workspaceDir });
