...
function setSlackDmPolicy(cfg: BitterbotConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Bitterbot";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Bitterbot`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: BitterbotConfig, allowFrom: string[]): BitterbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
