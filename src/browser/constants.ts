export const DEFAULT_BITTERBOT_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_BITTERBOT_BROWSER_COLOR = "#8b5cf6";
export const DEFAULT_BITTERBOT_BROWSER_PROFILE_NAME = "bitterbot";
