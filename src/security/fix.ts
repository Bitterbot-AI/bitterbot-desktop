...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof BitterbotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: BitterbotConfig; env: NodeJS.ProcessEnv }): {
  cfg: BitterbotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
