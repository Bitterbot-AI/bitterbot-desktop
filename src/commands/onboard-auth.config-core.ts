...
export function applyOpenrouterProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: BitterbotConfig): BitterbotConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: BitterbotConfig): BitterbotConfig {
...
export function applyMoonshotConfig(cfg: BitterbotConfig): BitterbotConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: BitterbotConfig): BitterbotConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: BitterbotConfig): BitterbotConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: BitterbotConfig): BitterbotConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: BitterbotConfig): BitterbotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: BitterbotConfig): BitterbotConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: BitterbotConfig): BitterbotConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: BitterbotConfig): BitterbotConfig {
...
export function applyQianfanProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: BitterbotConfig): BitterbotConfig {
