...
type PromptDefaultModelResult = { model?: string; config?: BitterbotConfig };
...
function resolveConfiguredModelRaw(cfg: BitterbotConfig): string {
...
function resolveConfiguredModelKeys(cfg: BitterbotConfig): string[] {
...
export function applyPrimaryModel(cfg: BitterbotConfig, model: string): BitterbotConfig {
...
export function applyModelAllowlist(cfg: BitterbotConfig, models: string[]): BitterbotConfig {
  const defaults = cfg.agents?.defaults;
