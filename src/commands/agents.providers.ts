...
function resolveDefaultAccountId(cfg: BitterbotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: BitterbotConfig): boolean {
...
export function summarizeBindings(cfg: BitterbotConfig, bindings: AgentBinding[]): string[] {
