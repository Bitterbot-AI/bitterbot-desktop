...
const ensureBitterbotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveBitterbotAgentDir = vi.fn().mockReturnValue("/tmp/bitterbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/bitterbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureBitterbotModelsJson,
}));
