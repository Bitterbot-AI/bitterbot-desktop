...
// PLAN-17 Phase 5: align with src/config/defaults.ts opus tier (claude-opus-4-8)
// and LITELLM_DEFAULT_MODEL_REF in onboard-auth.credentials.ts (already 4-7).
export const LITELLM_DEFAULT_MODEL_ID = "claude-opus-4-8";
...
export function applyLitellmProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
...
export function applyLitellmConfig(cfg: BitterbotConfig): BitterbotConfig {
