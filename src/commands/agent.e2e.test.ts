...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "bitterbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<BitterbotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<BitterbotConfig["telegram"]>>,
