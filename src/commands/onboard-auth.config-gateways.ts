...
export function applyVercelAiGatewayProviderConfig(cfg: BitterbotConfig): BitterbotConfig {
...
export function applyVercelAiGatewayConfig(cfg: BitterbotConfig): BitterbotConfig {
