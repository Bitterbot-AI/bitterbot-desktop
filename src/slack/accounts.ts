...
export function listSlackAccountIds(cfg: BitterbotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: BitterbotConfig): string {
...
function mergeSlackAccountConfig(cfg: BitterbotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: BitterbotConfig): ResolvedSlackAccount[] {
