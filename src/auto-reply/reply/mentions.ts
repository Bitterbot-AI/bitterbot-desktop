...
function resolveMentionPatterns(cfg: BitterbotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: BitterbotConfig | undefined, agentId?: string): RegExp[] {
