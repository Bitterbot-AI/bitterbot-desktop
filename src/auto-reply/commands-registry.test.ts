...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@bitterbot", { botUsername: "bitterbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@bitterbot args", {
        botUsername: "bitterbot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@bitterbot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "bitterbot" })).toBe(
      "/help@otherbot",
    );
  });
