...
const CORE_PACKAGE_NAMES = new Set(["bitterbot", "bitterbot"]);
...
export async function resolveBitterbotPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveBitterbotPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
