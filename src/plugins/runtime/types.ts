...
type CreateCuriosityResolveTool =
  typeof import("../../agents/tools/curiosity-tool.js").createCuriosityResolveTool;
type CreateMemoryStatusTool =
  typeof import("../../agents/tools/memory-status-tool.js").createMemoryStatusTool;
type CreateWorkingMemoryNoteTool =
  typeof import("../../agents/tools/working-memory-tool.js").createWorkingMemoryNoteTool;
...
export type PluginRuntime = {
  ...
  tools: {
    ...
    createCuriosityResolveTool: CreateCuriosityResolveTool;
    createMemoryStatusTool: CreateMemoryStatusTool;
    createWorkingMemoryNoteTool: CreateWorkingMemoryNoteTool;
