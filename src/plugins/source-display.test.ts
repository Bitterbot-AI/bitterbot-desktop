...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/bitterbot/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bitterbot/extensions",
        global: "/Users/x/.bitterbot/extensions",
        workspace: "/Users/x/ws/.bitterbot/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.bitterbot/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bitterbot/extensions",
        global: "/Users/x/.bitterbot/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.bitterbot/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bitterbot/extensions",
        global: "/Users/x/.bitterbot/extensions",
