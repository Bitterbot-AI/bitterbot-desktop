...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @bitterbot/voice-call -> voice-call).
...
export function discoverBitterbotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".bitterbot", "extensions")];
