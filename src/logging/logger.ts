...
import { resolvePreferredBitterbotTmpDir } from "../infra/tmp-bitterbot-dir.js";
import { readLoggingConfig } from "./config.js";
import { type LogLevel, levelToMinLevel, normalizeLogLevel } from "./levels.js";
import { loggingState } from "./state.js";

export const DEFAULT_LOG_DIR = resolvePreferredBitterbotTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "bitterbot.log"); // legacy single-file path (was bitterbot.log)

const LOG_PREFIX = "bitterbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: BitterbotConfig["logging"] | undefined =
  ...
  const defaultLevel =
    process.env.VITEST === "true" && process.env.BITTERBOT_TEST_FILE_LOG !== "1" ? "silent" : "info";
