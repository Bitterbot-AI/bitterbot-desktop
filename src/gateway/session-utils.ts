...
function listConfiguredAgentIds(cfg: BitterbotConfig): string[] {
...
export function listAgentsForGateway(cfg: BitterbotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: BitterbotConfig): string {
...
function resolveSessionStoreAgentId(cfg: BitterbotConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: BitterbotConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: BitterbotConfig): GatewaySessionsDefaults {
