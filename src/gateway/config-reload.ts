...
export function resolveGatewayReloadSettings(cfg: BitterbotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: BitterbotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: BitterbotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: BitterbotConfig) => void;
  log: {
