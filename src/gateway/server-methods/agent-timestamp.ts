 ...
 *
 * @see https://github.com/bitterbot/bitterbot/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an BitterbotConfig.
 */
export function timestampOptsFromConfig(cfg: BitterbotConfig): TimestampInjectionOptions {
  return {
