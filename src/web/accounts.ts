...
function listConfiguredAccountIds(cfg: BitterbotConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: BitterbotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: BitterbotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: BitterbotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: BitterbotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: BitterbotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: BitterbotConfig): ResolvedWhatsAppAccount[] {
