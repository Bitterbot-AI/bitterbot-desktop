...
export function listIMessageAccountIds(cfg: BitterbotConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: BitterbotConfig): string {
...
function mergeIMessageAccountConfig(cfg: BitterbotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: BitterbotConfig): ResolvedIMessageAccount[] {
