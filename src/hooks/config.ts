import type { BitterbotConfig, HookConfig } from "../config/config.js";
...
export function isConfigPathTruthy(config: BitterbotConfig | undefined, pathStr: string): boolean {
...
export function shouldIncludeHook(params: {
  ...
  const pluginManaged = entry.hook.source === "bitterbot-plugin";
