...
homepage: https://docs.bitterbot.ai/automation/hooks#bootstrap-extra-files
metadata:
  {
    "bitterbot":
      {
...
you want to include extra `TOOLS.md`/`PROTOCOLS.md`-class files without changing the
workspace root.
...
Only recognized bootstrap basenames are loaded (`GENOME.md`, `PROTOCOLS.md`, `TOOLS.md`,
