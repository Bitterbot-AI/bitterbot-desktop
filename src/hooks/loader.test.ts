...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "bitterbot-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.BITTERBOT_BUNDLED_HOOKS_DIR;
    process.env.BITTERBOT_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.BITTERBOT_BUNDLED_HOOKS_DIR;
    } else {
      process.env.BITTERBOT_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
