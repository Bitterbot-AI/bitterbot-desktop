...
import type { BitterbotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: BitterbotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: BitterbotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
