...
export const A2UI_PATH = "/__bitterbot__/a2ui";

export const CANVAS_HOST_PATH = "/__bitterbot__/canvas";

export const CANVAS_WS_PATH = "/__bitterbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.bitterbotCanvasA2UIAction.postMessage(...)
  // - Android: window.bitterbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["bitterbotCanvasA2UIAction"];
  ...
  globalThis.Bitterbot = globalThis.Bitterbot ?? {};
  globalThis.Bitterbot.postMessage = postToNode;
  globalThis.Bitterbot.sendUserAction = sendUserAction;
  globalThis.bitterbotPostMessage = postToNode;
  globalThis.bitterbotSendUserAction = sendUserAction;
