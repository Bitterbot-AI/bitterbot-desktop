...
var BitterbotA2UIHost = class extends i$6 {
  static properties = {
    surfaces: { state: true },
  ...
  #handleA2UIAction(evt) {
    ...
    const handler =
      globalThis.webkit?.messageHandlers?.bitterbotCanvasA2UIAction ??
      globalThis.bitterbotCanvasA2UIAction;
...
if (!customElements.get("bitterbot-a2ui-host")) {
  customElements.define("bitterbot-a2ui-host", BitterbotA2UIHost);
}
