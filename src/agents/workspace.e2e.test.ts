...
describe("resolveDefaultAgentWorkspaceDir", () => {
  it("uses BITTERBOT_HOME for default workspace resolution", () => {
    const dir = resolveDefaultAgentWorkspaceDir({
      BITTERBOT_HOME: "/srv/bitterbot-home",
      HOME: "/home/other",
    } as NodeJS.ProcessEnv);

    expect(dir).toBe(path.join(path.resolve("/srv/bitterbot-home"), ".bitterbot", "workspace"));
  });
});

const WORKSPACE_STATE_PATH_SEGMENTS = [".bitterbot", "workspace-state.json"] as const;
