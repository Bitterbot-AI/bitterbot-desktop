...
describe("createBitterbotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createBitterbotCodingTools({
      config,
    ...
    const anthropicTools = createBitterbotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createBitterbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createBitterbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
