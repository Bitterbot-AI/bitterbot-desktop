...
export function resolveSessionToolsVisibility(cfg: BitterbotConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: BitterbotConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: BitterbotConfig): AgentToAgentPolicy {
