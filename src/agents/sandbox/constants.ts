...
export const DEFAULT_SANDBOX_IMAGE = "bitterbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "bitterbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "bitterbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "bitterbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "bitterbot-sbx-browser-";
