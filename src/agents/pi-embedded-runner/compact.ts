...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureBitterbotModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createBitterbotCodingTools({
      exec: {
    ...
    try {
      ...
      try {
        ...
        // the expensive LLM-based compaction call. This reduces the volume
