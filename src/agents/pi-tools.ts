...
function resolveExecConfig(params: { cfg?: BitterbotConfig; agentId?: string }) {
...
function resolveFsConfig(params: { cfg?: BitterbotConfig; agentId?: string }) {
  const cfg = params.cfg;
...
export function createBitterbotCodingTools(options?: {
