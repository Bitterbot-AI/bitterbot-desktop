...
function resolveAvatarSource(cfg: BitterbotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: BitterbotConfig, agentId: string): AgentAvatarResolution {
