...
export function resolveWatchPaths(workspaceDir: string, config?: BitterbotConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: BitterbotConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: BitterbotConfig }) {
