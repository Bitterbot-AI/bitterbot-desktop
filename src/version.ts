...
declare const __BITTERBOT_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "bitterbot";
...
// Single source of truth for the current Bitterbot version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION =
  (typeof __BITTERBOT_VERSION__ === "string" && __BITTERBOT_VERSION__) ||
  process.env.BITTERBOT_BUNDLED_VERSION ||
