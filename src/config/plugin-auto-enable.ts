...
function isTelegramConfigured(cfg: BitterbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: BitterbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: BitterbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: BitterbotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: BitterbotConfig): boolean {
...
function isIMessageConfigured(cfg: BitterbotConfig): boolean {
...
function isWhatsAppConfigured(cfg: BitterbotConfig): boolean {
...
function isGenericChannelConfigured(cfg: BitterbotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: BitterbotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: BitterbotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: BitterbotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: BitterbotConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: BitterbotConfig, pluginId: string): BitterbotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
