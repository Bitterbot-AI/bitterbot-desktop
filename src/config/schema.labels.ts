export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.evolution.proposerModel": "Skill Proposer Model",
  ...
  "usage.ledger.enabled": "Usage Ledger Enabled",
  "usage.ledger.retentionDays": "Usage Retention (days)",
  "usage.budgets.mode": "Budget Mode",
  "usage.budgets.daily.usd": "Daily Budget (USD)",
  "usage.budgets.weekly.usd": "Weekly Budget (USD)",
  ...
  "tools.hotSet.enabled": "Hot-set tool exposure",
  "tools.hotSet.max": "Max hot tools",
  "tools.hotSet.always": "Always-hot tools",
  "tools.hotSet.perLane": "Hot tools per lane",
  "tools.resultMaxChars": "Tool result max chars",
