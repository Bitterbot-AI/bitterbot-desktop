...
export function parseBitterbotVersion(raw: string | null | undefined): BitterbotVersion | null {
  if (!raw) {
    return null;
  }
...
export function compareBitterbotVersions(
  ...
  const parsedA = parseBitterbotVersion(a);
