...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.BITTERBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: BitterbotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: BitterbotConfig): string {
...
function mergeTelegramAccountConfig(cfg: BitterbotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: BitterbotConfig): ResolvedTelegramAccount[] {
