...
import type { BitterbotConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: BitterbotConfig, agentId: string) {
  try {
