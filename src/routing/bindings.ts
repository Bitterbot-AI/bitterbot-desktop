...
export function listBindings(cfg: BitterbotConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: BitterbotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: BitterbotConfig) {
