...
bitterbot system heartbeat last
bitterbot logs --follow
bitterbot config get agents.defaults.heartbeat
bitterbot channels status --probe
```
...
```bash
bitterbot config get agents.defaults.heartbeat.activeHours
bitterbot config get agents.defaults.heartbeat.activeHours.timezone
bitterbot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
bitterbot cron list
bitterbot logs --follow
```
