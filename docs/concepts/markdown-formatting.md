...
Bitterbot formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** — see [docs](https://docs.bitterbot.ai).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.bitterbot.ai" }]
}
```
...
- Other channels (WhatsApp, MS Teams, Discord) still use plain text or
