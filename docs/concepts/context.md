...
- **System prompt** (Bitterbot-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
The system prompt is **Bitterbot-owned** and rebuilt each run. It includes:
