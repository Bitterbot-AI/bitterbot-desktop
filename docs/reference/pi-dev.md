...
This guide summarizes a sane workflow for working on the pi integration in Bitterbot.
...
State lives under the Bitterbot state directory. Default is `~/.bitterbot`. If `BITTERBOT_STATE_DIR` is set, use that directory instead.

To reset everything:

- `bitterbot.json` for config
...
- [https://docs.bitterbot.ai/testing](https://docs.bitterbot.ai/testing)
- [https://docs.bitterbot.ai/start/getting-started](https://docs.bitterbot.ai/start/getting-started)
