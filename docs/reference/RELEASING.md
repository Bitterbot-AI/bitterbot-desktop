...
- [ ] Update CLI/version strings: [`src/cli/program.ts`](https://github.com/Bitterbot-AI/bitterbot-desktop/blob/main/src/cli/program.ts) and the Baileys user agent in [`src/provider-web.ts`](https://github.com/Bitterbot-AI/bitterbot-desktop/blob/main/src/provider-web.ts).
- [ ] Confirm package metadata (name, description, repository, keywords, license) and `bin` map points to [`bitterbot.mjs`](https://github.com/Bitterbot-AI/bitterbot-desktop/blob/main/bitterbot.mjs) for `bitterbot`.
- [ ] If dependencies changed, run `pnpm install` so `pnpm-lock.yaml` is current.

2. **Build & artifacts**

- [ ] If A2UI inputs changed, run `pnpm canvas:a2ui:bundle` and commit any updated [`src/canvas-host/a2ui/a2ui.bundle.js`](https://github.com/Bitterbot-AI/bitterbot-desktop/blob/main/src/canvas-host/a2ui/a2ui.bundle.js).
