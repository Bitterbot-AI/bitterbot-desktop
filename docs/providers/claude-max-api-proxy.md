...
You can point Bitterbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Bitterbot
...
- [Anthropic provider](/providers/anthropic) - Native Bitterbot integration with Claude setup-token or API keys
