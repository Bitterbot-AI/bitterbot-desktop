---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Bitterbot"
read_when:
  - You want Xiaomi MiMo models in Bitterbot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Bitterbot uses
...
```bash
bitterbot onboard --auth-choice xiaomi-api-key
# or non-interactive
bitterbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
