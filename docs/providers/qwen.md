---
summary: "Use Qwen OAuth (free tier) in Bitterbot"
read_when:
  - You want to use Qwen with Bitterbot
...
```bash
bitterbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Bitterbot will sync credentials
