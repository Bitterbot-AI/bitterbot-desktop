---
summary: "Use Qianfan's unified API to access many models in Bitterbot"
read_when:
...
3. Bitterbot installed on your system
...
4. Copy the API key for use with Bitterbot

## CLI setup

```bash
bitterbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Bitterbot Configuration](/gateway/configuration)
