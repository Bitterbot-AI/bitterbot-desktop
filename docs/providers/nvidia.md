---
summary: "Use NVIDIA's OpenAI-compatible API in Bitterbot"
read_when:
  - You want to use NVIDIA models in Bitterbot
...
bitterbot onboard --auth-choice skip
bitterbot models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
