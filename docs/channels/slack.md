...
<Tabs>
  <Tab title="Socket Mode (default)">
    <Steps>
      ...
      <Step title="Configure Bitterbot">
...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Bitterbot HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `bitterbot pairing approve slack <code>`.
...
```json
{
  "display_information": {
    "name": "Bitterbot",
    "description": "Slack connector for Bitterbot"
  },
  "features": {
    "bot_user": {
      "display_name": "Bitterbot",
      "always_online": false
    },
    "app_home": {
    ...
    "slash_commands": [
      {
        "command": "/bitterbot",
        "description": "Send a message to Bitterbot",
        "should_escape": false
      }
    ]
  },
