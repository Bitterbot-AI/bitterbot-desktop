...
read_when:
  - Setting up Twitch chat integration for Bitterbot
title: "Twitch"
---
...
4. Configure the token:
   - Env: `BITTERBOT_TWITCH_ACCESS_TOKEN=...` (default account only)
...
```json5
{
  channels: {
    twitch: {
      enabled: true,
      username: "bitterbot", // Bot's Twitch account
      accessToken: "oauth:abc123...", // OAuth Access Token (or use BITTERBOT_TWITCH_ACCESS_TOKEN env var)
...
```bash
BITTERBOT_TWITCH_ACCESS_TOKEN=oauth:abc123...
```
