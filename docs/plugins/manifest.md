...
read_when:
  - You are building a Bitterbot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (bitterbot.plugin.json)

Every plugin **must** ship a `bitterbot.plugin.json` file in the **plugin root**.
Bitterbot uses this manifest to validate configuration **without executing plugin
