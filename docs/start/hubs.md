---
summary: "Hubs that link to every Bitterbot doc"
read_when:
...
<Note>
If you are new to Bitterbot, start with [Getting Started](/start/getting-started).
</Note>
...
- [Wizard](/start/wizard)
- [Setup](/start/setup)
- [Dashboard (local Gateway)](http://127.0.0.1:19001/)
- [Help](/help)
