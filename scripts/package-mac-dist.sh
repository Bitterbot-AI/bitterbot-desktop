...
# Output:
# - dist/Bitterbot.app
# - dist/Bitterbot-<version>.zip
# - dist/Bitterbot-<version>.dmg
...
APP="$ROOT_DIR/dist/Bitterbot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Bitterbot-$VERSION.zip"
DMG="$ROOT_DIR/dist/Bitterbot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Bitterbot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Bitterbot-$VERSION.dSYM.zip"
